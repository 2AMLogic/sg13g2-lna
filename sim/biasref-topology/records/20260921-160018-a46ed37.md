# 20260921-160018-a46ed37 -- flat PVT bias-reference design-space evidence (issue #33 / DR-0003)
...
- Terminal drop spans `0.679821 V` (`mpa_bcs_125c_i20u`) .. `1.09224 V`
  ...
  `20260921-160018-a46ed37-mpa-diode.csv`.
...
- Residual tone is PTAT-shaped as designed (this skeleton is NOT the
  ...
  `20260921-160018-a46ed37-core-minigrid.csv`.

### Phase C -- startup / latch

- Verdicts: PASS . See `20260921-160018-a46ed37-core-startup.csv` and
...
- Per-point generated netlists: `netlist-snapshots/20260921-160018-a46ed37/`
- Per-point raw ngspice logs / wrdata: `corners/20260921-160018-a46ed37/`
- CSVs: `records/20260921-160018-a46ed37-mpa-diode.csv`,
  `records/20260921-160018-a46ed37-core-minigrid.csv`,
  `records/20260921-160018-a46ed37-core-startup.csv`
